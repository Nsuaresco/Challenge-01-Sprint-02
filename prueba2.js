...
function draw() {
    ...
    if (canvas.getContext){
      var Xinicio=parseInt(start[0][0]);
      var Yinicio=parseInt(start[0][1]);
      var XFinal=parseInt(end[0][0]);
      var YFinal=parseInt(end[0][1]);
      var drawing = canvas.getContext('2d');
      drawing.lineWidth = 4;
      drawing.beginPath();
      drawing.moveTo(Xinicio,Yinicio);
      drawing.lineTo(XFinal, end[0][1]);
